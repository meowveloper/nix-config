---
name: orchestration
description: managing skill for long workflows. Delegates all work to subagents or other agents while coordinating, asking clarifying questions, and keeping the user informed.
---
