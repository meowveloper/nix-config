---
name: humanizer
description: Use when the user says 'humanize', 'remove AI tells', 'make this sound human', 'strip AI from this text', or 'rewrite to sound less like AI'. This skill rewrites drafts to remove AI artifacts (inflated importance, fake depth, cosmetic tells, conversational artifacts) and injects genuine voice (opinions, rhythm, first person, specificity, mixed feelings).
---
